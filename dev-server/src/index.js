...
ReactDom.render(
    <div>
        ...
        <JsonViewer
            ...
            updateRenderValue={e => {
                console.log('updateRenderValue callback', e);
            }}
        ...
        <JsonViewer
            ...
            shouldCollapse={({ src, type }) =>
                type === 'object' && src.constructor && src.constructor.name === 'Moment'
            }
        />
        ...
        <JsonViewer
            enableClipboard={false}
            src={getExampleJson1()}
            shouldCollapse={({ src, namespace, type }) => namespace.indexOf('moment') > -1}
            theme={{
                base00: 'white',
                base01: '#ddd',
                base02: '#ddd',
