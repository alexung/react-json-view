...
describe('<JsonObject />', function() {
    ...
    xit('Object mount, multiple data type labels', function() {
        let src = {
    ...
    xit('Array mount expanded', function() {
        let src = {
            arr1: [('arr2': ['test'])]
        };
        const wrapper = render(
    ...
    it('non-empty object should be expanded', function() {
        ...
        const wrapper = shallow(
            <JsonObject src={src} theme="rjv-default" namespace={['root']} collapsed={false} />
        );
