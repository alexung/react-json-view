...
describe('<VariableEditor />', function() {
    ...
    xit('VariableEditor click-to-edit should be visible', function() {
    ...
    xit('VariableEditor click-to-edit should be hidden when onEdit disabled', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor click-to-edit should be hidden when editMode is active', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor test textarea and cancel icon', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor test textarea and submit icon', function() {
        ...
        expect(wrapper.find('.variable-editor').props().value).to.equal(existing_value);
        //update edit value
    ...
    xit('VariableEditor edit after src change should respect current src', function() {
        const existing_value = 'existing_value';
        const new_value = 'new_value';
        const wrapper = shallow(
            <VariableEditor
    ...
    xit('VariableEditor detected null', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor detected undefined', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor detected NaN', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor detected string', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor detected function', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
        ...
        wrapper.find('.click-to-edit-icon').simulate('click');
        expect(wrapper.state('editMode')).to.equal(true);
        expect(wrapper.find('.variable-editor').props().value).to.equal('function test() {}');
    });

    xit('VariableEditor detected object', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor detected array', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor detected float', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
    ...
    xit('VariableEditor detected integer', function() {
        const wrapper = shallow(
            <VariableEditor
                src={{ test: true }}
                theme="rjv-default"
